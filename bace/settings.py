...
SECRET_KEY = 'django-insecure-jiagojx^7+m*&u1s=mdj#o**t(09ehj@x0z3k4gw+%k2qtziqb'
...
SESSION_COOKIE_AGE = 10000  # 2 soat (sekundda)
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Superuser browser sessionlari uchun SessionAuthentication qo'shildi
